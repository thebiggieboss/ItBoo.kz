<template>
  <transition name="fade" appear>
    <div class="full-size-dialog-component">
      ...
      <div class="full-size-dialog-component__close-btn" @click="$emit('close')"></div>
    </div>
  </transition>
</template>
...
.full-size-dialog-component {
  ...
  &__content {
    ...
    .full-size-dialog-component__close-button {
      position: absolute;
      top: 16px;
      right: 16px;
      width: 48px;
